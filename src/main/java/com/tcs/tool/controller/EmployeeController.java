...
public class EmployeeController {
	...
	@GetMapping("/employees/allGreaterThanId/{id}")
	public List<Employee> getEmployeeIdGreaterThan2(@PathVariable(value = "id") Long employeeId){
		return employeeRepository.getEmployeeUsingQuery(employeeId);  
	}
